...
CREATE TABLE `address_code` (
  `address_code_id` int NOT NULL AUTO_INCREMENT,
  `post_code` varchar(7) DEFAULT NULL,
  `city` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`address_code_id`),
  UNIQUE KEY `address_code_id_UNIQUE` (`address_code_id`)
...
INSERT INTO `address_code` VALUES (1,'se1313A','london'),(2,'ma1123','manchester'),(3,'9re321','norwich'),(4,'qwerty','newcastle'),(5,'lkjgfd','edinburgh');
